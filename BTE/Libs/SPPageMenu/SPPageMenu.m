...
- (void)initialize {
    ...
    _itemPadding = 30.0;
    _selectedItemTitleColor =  BHColorBlue;
//    [UIColor redColor];
    _unSelectedItemTitleColor = BHColorFontGray;
//    [UIColor blackColor];
    _selectedItemTitleFont =  UIFontRegularOfSize(14);
//    [UIFont systemFontOfSize:16];
    _unSelectedItemTitleFont = UIFontRegularOfSize(14);
//    [UIFont systemFontOfSize:16];
    _itemTitleFont = UIFontRegularOfSize(14);
//    [UIFont systemFontOfSize:16];
    _trackerHeight = 3.0;
