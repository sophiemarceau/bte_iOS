...
@interface BTEKlineWebViewController ()<UITableViewDelegate,UITableViewDataSource,ZTYChartProtocol,UIWebViewDelegate>
...
@implementation BTEKlineWebViewController
...
//                    NSDictionary * dict = [list objectAtIndex:(list.count - 1 - index)];
//                    ZTYKlineComment * comment = [[ZTYKlineComment alloc] initWidthDict:dict];
//                    for (ZYWCandleModel * model in weakSelf.candleChartView.dataArray) {
//                        if ([comment.klineDateTime integerValue] == [model.timestam integerValue]){
