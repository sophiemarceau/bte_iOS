...
#import "FormatUtil.h"
@interface BTEMarketTableViewCell ()
...
@implementation BTEMarketTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        CGFloat cellHeight = [BTEMarketTableViewCell cellHeight];
        
        self.baseLabel = [self createlabelframe:CGRectMake(16, 17, 80, 14)];
        ...
        self.priceLabel =  [self createlabelframe:CGRectMake(147, 15, 90, 18)];
        ...
        self.cnyLabel = [self createlabelframe:CGRectMake(147, 38, 90, 10)];
        self.cnyLabel.textAlignment = NSTextAlignmentRight;
        [self.contentView addSubview:self.cnyLabel];
        //        self.cnyLabel.textAlignment = NSTextAlignmentRight;
        //        self.priceLabel.textAlignment = NSTextAlignmentRight;
        
        self.dropLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 72 - 16, 19, 72, 26)];
