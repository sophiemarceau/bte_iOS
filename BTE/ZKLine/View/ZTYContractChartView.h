...
@interface ZTYContractChartView : ZTYBaseChartView
<ZTYChartProtocol>
...
@property (assign,nonatomic) int lineAndMaxLine;

@property (nonatomic,assign) BOOL showOrder;
//@property (nonatomic,assign) BOOL showSupportOrder;
//@property (nonatomic,assign) BOOL showResistanceOrder;
//@property (nonatomic,assign) BOOL showCancleOrder;
//@property (nonatomic,assign) BOOL showBurnedOrder;
