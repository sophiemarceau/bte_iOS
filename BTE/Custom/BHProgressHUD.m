...
@property (nonatomic,strong) BTEMBProgressHUD *loadingHUD;
@property (nonatomic,strong) BTEMBProgressHUD *viewHUD;
...
- (BTEMBProgressHUD *)loadingHUD{
    if(_loadingHUD == nil){
        _loadingHUD = [BTEMBProgressHUD showHUDAddedTo:[UIApplication sharedApplication].keyWindow animated:YES];
    }
...
- (void)showViewHUDWithTitle:(NSString *)title{
    if(_viewHUD == nil){
        _viewHUD = [BTEMBProgressHUD showHUDAddedTo:[UIApplication sharedApplication].keyWindow animated:YES];
    }
