...
+ (UIImageView *)addBlurryScreenImage {
...
+ (UIImageView *)addBlurryScreenImageRadius:(CGFloat)radius {
    UIImageView *imgView    = [[UIImageView alloc]initWithFrame:[UIScreen mainScreen].bounds];
    
    imgView.tag             = ScreenImgViewTag;
    imgView.image           = [[self screenShot] imgWithLightAlpha:0.1 radius:radius colorSaturationFactor:1]; //添加毛玻璃
